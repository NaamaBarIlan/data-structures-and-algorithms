...
const getHouses = (arr) => {
  let houses = [];
  // loop through the object keys, if the key === house pull the value and push into the houses array
  for(let i = 0; i < arr.length; i++){
    let character = arr[i];
    let getHouse = character.house;
    houses.push(getHouse);
  }
  return houses;
};
...
const hasChildrenValues = (arr, character) => {
  ...
  //     let character = arr[i];
  //     let hasChild = character.children;

//     // if/else - if value === null return false, else return true.  
//     if(Object.values(hasChild) === ''){
//       return false;
//     } else {
//       return true;
//     }
