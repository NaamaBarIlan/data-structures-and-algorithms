...
const validatePin = (pin) => {
  return pin.match(/\b\d{4}\b/g)
};

// const validatePin = (pin) => {
// let validator = /\b\d{4}\b/g;
//   let matchVal = pin.match(validator)
//   if (matchVal === true){
//     return true;
//   } else {
//     return false;
...
const validateEmail = (email) => {
  let wordsBeforeAt = /\b\w+\b[.]\b\w+\b[@]|\b\w+\b[@]/g;
  let domainVal = /.(com|org|net)/g;
  let noSpecialChar = /[A-Za-z0-9-]/g;
};
